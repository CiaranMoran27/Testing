...
- Analysis.py is the Python module written for this Project.<br/>
      - The module contains the source code used to generate the Summary Text file and output plots, however it does make some   
        directory hierarchy assumptions relative to its location and thereforce would perform best if this repository is cloned, see here (**<https://docs.github.com/en/github/creating-cloning>**). <br/> 
